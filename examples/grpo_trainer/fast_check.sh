...
# set verl_home
export VERL_HOME="/apdcephfs_zwfy10_303541817/share_303541817/lgm/verl-workspace/verl"
...
MODEL_PATH=${MODEL_PATH:-${VERL_HOME}/models/Qwen3-8B}
NNODES=${NNODES:-1}
...
ppo_max_token_len_per_gpu=${PPO_MAX_TOKEN_LEN_PER_GPU:-8192} # 每个micro-batch的token数
